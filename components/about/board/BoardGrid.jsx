        ...
        <div className="grid lg:grid-cols-2 gap-12 pt-12">
          ...
          >
            ...
            <div className="p-10 md:w-1/2 flex flex-col justify-center space-y-4">
              <Badge variant="outline" className="w-fit border-secondary text-secondary font-bold uppercase">
                {ceo.role}
              </Badge>
          ...
          >
            ...
            <div className="p-10 md:w-1/2 flex flex-col justify-center space-y-4">
              <Badge variant="outline" className="w-fit border-primary text-primary font-bold uppercase">
                {executive.role}
              </Badge>
              <h3 className="text-2xl font-black text-primary uppercase">
                {executive.name}

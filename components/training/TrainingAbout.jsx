    ...
    <div className="container mx-auto px-4">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          <Badge
            variant="outline"
            className="border-secondary text-primary font-bold px-4 py-1"
          >
            {data.badge}
          </Badge>
          <h2 className="text-4xl lg:text-5xl font-black text-primary leading-tight">
            {data.title} <br />
            <span className="text-secondary text-2xl">{data.subtitle}</span>
          </h2>
          ...
          <Button
            size="lg"
            className="bg-primary hover:bg-primary/90 text-white rounded-full px-10 h-14 font-bold"
            asChild
          >
